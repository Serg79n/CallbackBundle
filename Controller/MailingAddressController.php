...
class MailingAddressController extends Controller {
    ...
    public function updateAction(Request $request, $id) {
        ...
        if ($editForm->isValid()) {
            ...
            $this->get('session')->setFlash('notice', $this->get('translator')->trans('"%email%" is successfully updated!', array('%email%' => $entity->getEmail()))
            );
    ...
    public function deleteAction(Request $request, $id) {
        ...
        if ($form->isValid()) {
            ...
            $this->get('session')->setFlash('notice', $this->get('translator')->trans('"%email%" is successfully deleted!', array('%email%' => $entity->getEmail()))
            );
        } else {
            $this->get('session')->setFlash('error', $this->get('translator')->trans('Error deleting "%email%".', array('%email%' => $entity->getEmail()))
            );
        }
