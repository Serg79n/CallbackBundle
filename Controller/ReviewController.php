...
class ReviewController extends Controller
{
    ...
    public function updateAction(Request $request, $id) {
        ...
        if ($editForm->isValid()) {
            ...
            $this->get('session')->setFlash('notice', $this->get('translator')->trans('Callback "ID" = %id% is successfully updated!', array('%id%' => $id))
            );
     ...
     public function deleteAction(Request $request, $id) {
        ...
        if ($form->isValid()) {
            ...
            $this->get('session')->setFlash('notice', $this->get('translator')->trans('Callback whith "ID" = %id% is successfully deleted!', array('%id%' => $entity->getId()))
            );
        } else {
            $this->get('session')->setFlash('error', $this->get('translator')->trans('Error deleting review whith "ID" = %id%.', array('%id%' => $entity->getId()))
            );
        }
